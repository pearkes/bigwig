/**
 * Form Schema Types for Client
 *
 * Mirror of worker/workspace/tools/lib/form-schema.ts
 * These types define forms that can be dynamically rendered from AI-generated specs.
 */
...
export type FormValues = Record<
	string,
	string | number | boolean | string[] | CreditCardValue | undefined
>;
